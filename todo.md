...
- [x] make it so when it calls the end_voting it closes the channel permissions so users can VIEW the channel but not longer speak. i do this manually at the moment
- [x] make it so when a user has lifetime, remove vip without adding the free roles
